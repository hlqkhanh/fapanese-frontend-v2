...
const LessonSidebar = ({ lesson, activeContent, onContentSwitch }: LessonSidebarProps) => {
  ...
  return (
    <div className="w-full bg-white/70 backdrop-blur-xl rounded-2xl lg:rounded-3xl shadow-lg p-4 lg:p-6 space-y-4 lg:space-y-6 border border-gray-100 lg:h-fit lg:sticky lg:top-20 transition-all duration-500">
      ...
      <div className="space-y-4 lg:space-y-5">
        <h3 className="text-base lg:text-lg font-semibold text-gray-800 border-b border-gray-100 pb-2 tracking-wide">
          {lessonTitle}
        </h3>
        ...
        {parts.map((part, idx) => (
          <Link
            ...
            className={`flex items-center gap-3 lg:gap-4 p-3 lg:p-4 rounded-xl lg:rounded-2xl border border-transparent transition-all duration-300 group ${
          ...
          >
            <div
              className={`w-10 h-10 lg:w-11 lg:h-11 flex items-center justify-center rounded-lg lg:rounded-xl transition-transform duration-300 ${
                activeContent === part.key
            ...
            <div className="flex-1">
              <p
                className={`text-sm lg:text-[15px] font-medium tracking-wide transition-colors duration-300 ${
                  activeContent === part.key
                    ? "text-[#0097A7]"
